<?php
/**
 * AfterPay Installments payment method for Norway
 *
 * @category   Class
 ...
 * AfterPay Installments payment method for Norway
 *
 * @class         WC_Gateway_Afterpay_No_Installments
 * @extends       WC_Gateway_Afterpay_Base_Rest
 * @package       Arvato_AfterPay
 * @author        AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_No_Installments extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_no_installments';
		$this->method_title = __( 'Riverty Norway Fixed instalments', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->title             = 'Riverty Fix – Fast nedbetaling hver måned';
		$this->extra_information = 'Samme beløp hver måned. Betal gjenstående beløp når du vil.';
		...
		$this->form_fields = apply_filters(
			'afterpay_no_installments_form_fields', array(
				'enabled'                               => array(
					...
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Norway Fixed instalments', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
	...
	public function payment_fields() {
		...
		<fieldset class="riverty_fieldset">
			<p class="form-row">
				<label for="afterpay_installmentplan"><strong>Faste månedsbetalinger</strong></label>
				<?php 
				...
				<div class="installment_plan 
					...
					<p class="afterpay_terms_and_conditions">
						Totalkostnad for <?php echo esc_html( $installment_plan->basketAmount ); ?> kr betalt over <?php echo esc_html( $installment_plan->numberOfInstallments ); ?> måneder er kr <?php echo esc_html( $installment_plan->totalAmount ); ?> med rente <?php echo esc_html( $installment_plan->effectiveAnnualPercentageRate ); ?> %.
