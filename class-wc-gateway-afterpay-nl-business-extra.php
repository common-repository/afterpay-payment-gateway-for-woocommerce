<?php
/**
 * AfterPay Extra B2B Open Invoice payment method for the Netherlands
 *
 * @category   Class
 ...
 * AfterPay Extra B2B Open Invoice payment method for the Netherlands
 *
 * @class         WC_Gateway_Afterpay_Nl_Business_Extra
 * @extends       WC_Gateway_Afterpay_Base
 * @package       Arvato_AfterPay
 * @author        AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_Nl_Business_Extra extends WC_Gateway_Afterpay_Base {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_business_extra';
		$this->method_title = __( 'Riverty Netherlands B2B invoice extra (Legacy SOAP)', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->form_fields = apply_filters(
			'afterpay_nl_business_form_fields', array(
				'enabled'                               => array(
					...
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Netherlands B2B invoice extra (Legacy SOAP)', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'title'                                 => array(
