<?php
/**
 * AfterPay Open invoice payment method for the Netherlands
 *
 * @category   Class
 ...
 * AfterPay Open invoice payment method for the Netherlands
 *
 * @class         WC_Gateway_Afterpay_Nl_Openinvoice
 * @extends       WC_Gateway_Afterpay_Base
 * @package  Arvato_AfterPay
 * @author        AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_Nl_Openinvoice extends WC_Gateway_Afterpay_Base {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_openinvoice';
		$this->method_title = __( 'Riverty Netherlands 14-day invoice (Legacy SOAP)', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->form_fields = apply_filters(
			'afterpay_nl_openinvoice_form_fields', array(
				'enabled'                               => array(
					...
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Netherlands 14-day invoice (Legacy SOAP)', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'title'                                 => array(
