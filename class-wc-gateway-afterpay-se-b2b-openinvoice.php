<?php
/**
 * AfterPay B2B invoice payment method for Sweden
 *
 * @category   Class
 ...
 * AfterPay B2B invoice payment method for Sweden
 *
 * @class         WC_Gateway_Afterpay_Se_B2B_Openinvoice
 * @extends       WC_Gateway_Afterpay_Base_Rest
 * @package       Arvato_AfterPay
 * @author        AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_Se_B2B_Openinvoice extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_se_b2b_openinvoice';
		$this->method_title = __( 'Riverty Sweden B2B invoice', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->title             = 'Faktura för företag';
		$this->extra_information = 'Handla nu, betala om 30 dagar';
	...
	public function init_form_fields() {
		...
		$this->form_fields = apply_filters(
			'afterpay_se_b2b_openinvoice_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Sweden B2B invoice', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
	...
	public function payment_fields() {
		...
		<fieldset class="riverty_fieldset">
			...
			<p class="form-row validate-required">
				<label for="<?php esc_html_e( $this->id ); ?>_companyname"><strong>Företagets namn: <span class="required">*</span></strong></label>
