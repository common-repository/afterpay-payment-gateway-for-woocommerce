<?php
/**
 * AfterPay Open invoice payment method for Finland
 *
 * @category   Class
 ...
 * AfterPay Open invoice payment method for Finland
 *
 * @class    WC_Gateway_Afterpay_Fi_Openinvoice
 * @extends  WC_Gateway_Afterpay_Base_Rest
 * @package  Arvato_AfterPay
 * @author   AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_Fi_Openinvoice extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_fi_openinvoice';
		$this->method_title = __( 'Riverty Finland 14-day invoice', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->title             = 'Maksa myöhemmin';
		$this->extra_information = 'Kokeile ensin, maksa 14 päivän kuluessa';
	...
	public function init_form_fields() {
		...
		$this->form_fields = apply_filters(
			'afterpay_fi_openinvoice_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Finland 14-day invoice', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
