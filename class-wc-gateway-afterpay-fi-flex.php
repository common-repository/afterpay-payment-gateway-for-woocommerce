<?php
/**
 * AfterPay Flex payment method for Finland
 *
 * @category   Class
 ...
 * AfterPay Flex payment method for Finland
 *
 * @class         WC_Gateway_Afterpay_Fi_Flex
 * @extends       WC_Gateway_Afterpay_Base_Rest
 * @package       Arvato_AfterPay
 * @author        AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_Fi_Flex extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_fi_flex';
		$this->method_title = __( 'Riverty Finland Flex payment', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->title             = 'Flex - maksa joustavasti osissa';
		$this->extra_information = 'Maksa omaan tahtiin. Lisää useampia ostoksia yhdelle kuukausittaiselle tililaskulle.';
	...
	public function init_form_fields() {
		...
		$this->form_fields = apply_filters(
			'afterpay_fi_flex_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Finland Flex payment', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
	...
	public function payment_fields() {
		...
		<fieldset class="riverty_fieldset">
			...
			<?php endif; ?>
			<p class="form-row">
				<p>Kuukausierä: vähintään <?php echo esc_html( round( $this->available_flex_information['installmentAmount'], 2 ) ); ?> € tai noin 10% kokonaismäärästä</p>
				<ul class="afterpay_installment_bullets" style="margin-top: 10px;">
					<li style="list-style-type: circle !important;">Ei aloitusmaksua</li>
					<li style="list-style-type: circle !important;">Luotonhoitokulut: <?php echo esc_html( number_format( $this->available_flex_information['monthlyFee'], 2 ) ); ?> € / kk</li>
					<li style="list-style-type: circle !important;">Vuosikorko: <?php echo esc_html( $this->available_flex_information['interestRate'] ); ?> %</li>
				</ul>
				<p>Luottohakemus on viimeisteltävä oston jälkeen.</p>
				<br/>
				<p>Esimerkki: Jos maksuaika on 12 kuukautta, 1 000,00 euron luoton todellinen vuosikorko on 28,72 %. Tällöin maksettava kokonaismäärä on 1 143,55 euroa, josta luottokustannusten osuus on 143,55 euroa. Katso <a href="<?php echo $this->available_flex_information['readMore']; ?>" target="blank">Vakiomuotoiset Eurooppalaiset kuluttajaluottotiedot</a></p>
				<br/>
