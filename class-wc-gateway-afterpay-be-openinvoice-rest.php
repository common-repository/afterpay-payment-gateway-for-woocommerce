<?php
/**
 * AfterPay Open invoice payment method for Belgium using REST
 *
 * @category   Class
 ...
 * AfterPay Open invoice payment method for Belgium using REST
 *
 * @class       WC_Gateway_Afterpay_Be_Openinvoice_Rest
 * @extends     WC_Gateway_Afterpay_Base_Rest
 * @package     Arvato_AfterPay
 * @author      AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_Be_Openinvoice_Rest extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_be_openinvoice_rest';
		$this->method_title = __( 'Riverty Belgium 14-day invoice', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->title             = 'Veilig achteraf betalen';
	...
	public function init_form_fields() {
		$this->form_fields = apply_filters(
			'afterpay_be_openinvoice_rest_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Belgium 14-day invoice', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
