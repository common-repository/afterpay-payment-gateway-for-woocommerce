<?php
/**
 * AfterPay Open invoice payment method for Denmark
 *
 * @category   Class
 ...
 * AfterPay Open invoice payment method for Denmark
 *
 * @class         WC_Gateway_Afterpay_Dk_Openinvoice
 * @extends       WC_Gateway_Afterpay_Base_Rest
 * @package       Arvato_AfterPay
 * @author        AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_Dk_Openinvoice extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_dk_openinvoice';
		$this->method_title = __( 'Riverty Denmark 14-day invoice', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->title             = 'Faktura 14 dage';
		$this->extra_information = 'Oplev først, betal senere';
	...
	public function init_form_fields() {
		...
		$this->form_fields = apply_filters(
			'afterpay_dk_openinvoice_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Denmark 14-day invoice', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
