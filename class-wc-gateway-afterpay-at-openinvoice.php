<?php
/**
 * AfterPay Open invoice payment method for Austria
 *
 * @category   Class
...
class WC_Gateway_Afterpay_At_Openinvoice extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_at_openinvoice';
		$this->method_title = __( 'Riverty Austria 14-day invoice', 'afterpay-payment-gateway-for-woocommerce' );
	...
	public function init_form_fields() {
		$this->form_fields = apply_filters(
			'afterpay_at_openinvoice_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Austria 14-day invoice', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
		...
		<fieldset class="riverty_fieldset">
			...
			<p class="form-row" style="margin-top:15px">
				...
				<label style="display:inline">
					<?php echo $this->get_tracking_text('invoice', 'at'); ?>
				</label>
			</p>
