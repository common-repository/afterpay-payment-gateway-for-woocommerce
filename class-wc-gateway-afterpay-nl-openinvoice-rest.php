...
class WC_Gateway_Afterpay_Nl_Openinvoice_Rest extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->method_title = __( 'Riverty Netherlands 14-day invoice', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->form_fields = apply_filters(
			'afterpay_nl_openinvoice_rest_form_fields', array(
				'enabled'                               => array(
					...
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Netherlands 14-day invoice', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
