...
class WC_Gateway_Afterpay_No_Campaign extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function payment_fields() {
		...
		<fieldset class="riverty_fieldset">
			...
			<?php endif; ?>			
			<input type="hidden" name="<?php echo esc_attr( $this->id ); ?>_campaign_number" id="<?php echo esc_attr( $this->id ); ?>_campaign_number" value="<?php echo $this->available_campaign_information['campaignNumber']; ?>"/>
			<p class="form-row">
