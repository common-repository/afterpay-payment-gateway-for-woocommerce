<?php
/**
 * AfterPay Open invoice payment method for Belgium
 *
 * @category   Class
...
class WC_Gateway_Afterpay_Be_Openinvoice extends WC_Gateway_Afterpay_Base {
	...
	public function __construct() {
		...
		$this->method_title = __( 'Riverty Belgium 14-day invoice (Legacy SOAP)', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$country_code 			    = ( $current_locale == 'nl' ) ? 'be_nl/' : ( ( $current_locale == 'fr' ) ? 'be_fr/' : 'be_en/' );
	...
	public function init_form_fields() {
		...
		$this->form_fields = apply_filters(
			'afterpay_be_openinvoice_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Belgium 14-day invoice (Legacy SOAP)', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'title'                                 => array(
