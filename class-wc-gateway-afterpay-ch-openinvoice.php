<?php
/**
 * AfterPay Open invoice payment method for Switzerland
 *
 * @category   Class
...
/**
 * Open invoice payment method for AfterPay Switzerland
 *
...
class WC_Gateway_Afterpay_Ch_Openinvoice extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->method_title = __( 'Riverty Switzerland 14-day invoice', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$country_code 			    = ( $current_locale == 'de' ) ? 'de_ch/' : ( ( $current_locale == 'fr' ) ? 'fr_ch/' : ( ( ( $current_locale == 'it' ) ? 'it_ch/' : 'en_ch/' ) ) );
	...
	public function init_form_fields() {
		$this->form_fields = apply_filters(
			'afterpay_ch_openinvoice_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Switzerland 14-day invoice', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
		...
		<fieldset class="riverty_fieldset">
			...
			<p class="form-row" style="margin-top:15px">
				...
				<label style="display:inline">
					<?php echo $this->get_tracking_text('invoice', 'ch'); ?>
				</label>
			</p>
