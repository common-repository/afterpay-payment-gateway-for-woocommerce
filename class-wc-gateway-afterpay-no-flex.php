...
class WC_Gateway_Afterpay_No_Flex extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->method_title = __( 'Riverty Norway Flex payment', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->extra_information = 'Samle alle kjøp på én månedsfaktura. Velg selv hvor mye du betaler hver måned.';
		...
		$this->form_fields = apply_filters(
			'afterpay_no_installments_form_fields', array(
				'enabled'                               => array(
					...
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Norway Flex payment', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
	...
	public function payment_fields() {
		...
		<fieldset class="riverty_fieldset">
			...
			<div class="clear"></div>
			<p class="form-row">
				<label for="<?php echo esc_attr( $this->id ); ?>_ssn"><strong>Tast inn ditt personnummer (11 siffer) for å fullføre kjøpet: <span class="required">*</span></strong></label>
