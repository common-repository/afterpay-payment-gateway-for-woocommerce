<?php
/**
 * AfterPay Installments payment method for Finland
 *
 * @category   Class
 ...
 * AfterPay Installments payment method for Finland
 *
 * @class         WC_Gateway_Afterpay_Fi_Installments
 * @extends       WC_Gateway_Afterpay_Base_Rest
 * @package       Arvato_AfterPay
 * @author        AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_Fi_Installments extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_fi_installments';
		$this->method_title = __( 'Riverty Finland Fixed instalments', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->title             = 'Maksa tasaisissa kuukausierissä';
		$this->extra_information = 'Ei yllätyksiä – maksat aina saman summan joka kuukausi.';
	...
	public function init_form_fields() {
		...
		$this->form_fields = apply_filters(
			'afterpay_fi_installments_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Finland Fixed instalments', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
	...
	public function payment_fields() {
		...
		<fieldset class="riverty_fieldset">
			<p class="form-row">
				<label for="afterpay_installmentplan"><strong>Kuukausierä</strong></label>
				<?php 
				...
				<div class="installment_plan 
					...
					<p class="afterpay_terms_and_conditions">
						Kun maksuaika on <?php echo esc_html( $installment_plan->numberOfInstallments ); ?> kuukautta, <?php echo esc_html( $installment_plan->basketAmount ); ?> euron luoton todellinen vuosikorko on <?php echo esc_html( $installment_plan->effectiveAnnualPercentageRate ); ?>  %. Tällöin maksettava kokonaismäärä on <?php echo esc_html( $installment_plan->totalAmount ); ?> € euroa, josta luottokustannusten osuus on <?php echo esc_html( $installment_plan->totalAmount - $installment_plan->basketAmount ); ?>  euroa.
