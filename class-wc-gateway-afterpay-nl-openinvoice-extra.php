<?php
/**
 * AfterPay Extra Open invoice payment method for the Netherlands
 *
 * @category   Class
 ...
 * AfterPay Extra Open invoice payment method for the Netherlands
 *
 * @class         WC_Gateway_Afterpay_Nl_Openinvoice_Extra
 * @extends       WC_Gateway_Afterpay_Base
 * @package       Arvato_AfterPay
 * @author        AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_Nl_Openinvoice_Extra extends WC_Gateway_Afterpay_Base {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_openinvoice_extra';
		$this->method_title = __( 'Riverty Netherlands 14-day invoice extra (Legacy SOAP)', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->notification_mail = ( isset( $this->settings['notification_mail'] ) ) ?
	...
	public function init_form_fields() {
		...
		$this->form_fields = apply_filters(
			'afterpay_nl_openinvoice_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Netherlands 14-day invoice extra (Legacy SOAP)', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'title'                                 => array(
				...
				'notification_mail'                     => array(
					'title'       => __( 'Notification mail', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'        => 'text',
					'description' => __(
						'Use notification mail to receive a notification when an order was accepted by Riverty and can be processed. Leave empty to disable.',
						'afterpay'
					),
					'default'     => '',
				),
