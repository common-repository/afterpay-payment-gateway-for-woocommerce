<?php
/**
 * AfterPay B2B invoice payment method for Norway
 *
 * @category   Class
 ...
 * AfterPay B2B invoice payment method for Norway
 *
 * @class         WC_Gateway_Afterpay_No_B2B_Openinvoice
 * @extends       WC_Gateway_Afterpay_Base_Rest
 * @package  Arvato_AfterPay
 * @author        AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_No_B2B_Openinvoice extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_no_b2b_openinvoice';
		$this->method_title = __( 'Riverty Norway B2B invoice', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->title             = 'Faktura for bedrifter';
		$this->extra_information = 'Handle nå, betal innen 30 dager';
	...
	public function init_form_fields() {
		...
		$this->form_fields = apply_filters(
			'afterpay_no_b2b_openinvoice_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Norway B2B invoice', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
	...
	public function payment_fields() {
		...
		<fieldset class="riverty_fieldset">
			...
			<p class="form-row validate-required">
				<label for="<?php esc_html_e( $this->id ); ?>_companyname"><strong>Selskapets navn: <span class="required">*</span></strong></label>
				<input type="input" class="input-text" name="<?php esc_html_e( $this->id ); ?>_companyname" />
			</p>	
			<p class="form-row validate-required">
				<label for="<?php esc_html_e( $this->id ); ?>_cocnumber"><strong>Orgno: <span class="required">*</span></strong></label>
