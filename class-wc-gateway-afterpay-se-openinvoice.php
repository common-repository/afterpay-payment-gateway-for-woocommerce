<?php
/**
 * AfterPay Open invoice payment method for Sweden
 *
 * @category   Class
 ...
 * AfterPay Open invoice payment method for Sweden
 *
 * @class         WC_Gateway_Afterpay_Se_Openinvoice
 * @extends       WC_Gateway_Afterpay_Base_Rest
 * @package       Arvato_AfterPay
 * @author        AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_Se_Openinvoice extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_se_openinvoice';
		$this->method_title = __( 'Riverty Sweden 14-day invoice', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->title             = 'Faktura 14 dagar';
		$this->extra_information = 'Upplev först, betala senare';
	...
	public function init_form_fields() {
		...
		$this->form_fields = apply_filters(
			'afterpay_se_openinvoice_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Sweden 14-day invoice', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
