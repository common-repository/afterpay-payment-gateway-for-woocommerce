<?php
/**
 * AfterPay B2B Open Invoice payment method for Netherlands using REST
 *
 * @category   Class
 ...
 * AfterPay B2B Open Invoice payment method for Netherlands using REST
 *
 * @class       WC_Gateway_Afterpay_Nl_Business_Rest
 * @extends     WC_Gateway_Afterpay_Base_Rest
 * @package     Arvato_AfterPay
 * @author      AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_Nl_Business_Rest extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_business_rest';
		$this->method_title = __( 'Riverty Netherlands B2B invoice', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->title             = 'Veilig achteraf betalen voor bedrijven';
	...
	public function init_form_fields() {
		$this->form_fields = apply_filters(
			'afterpay_nl_business_rest_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Netherlands B2B invoice', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
