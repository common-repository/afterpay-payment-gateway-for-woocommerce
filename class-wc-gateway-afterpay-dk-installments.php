<?php
/**
 * AfterPay Installments payment method for Denmark
 *
 * @category   Class
 ...
 * AfterPay Installments payment method for Denmark
 *
 * @class         WC_Gateway_Afterpay_Dk_Installments
 * @extends       WC_Gateway_Afterpay_Base_Rest
 * @package       Arvato_AfterPay
 * @author        AfterPay
 */
#[AllowDynamicProperties]
class WC_Gateway_Afterpay_Dk_Installments extends WC_Gateway_Afterpay_Base_Rest {
	...
	public function __construct() {
		...
		$this->id           = 'afterpay_dk_installments';
		$this->method_title = __( 'Riverty Denmark Fixed instalments', 'afterpay-payment-gateway-for-woocommerce' );
		...
		$this->title             = 'Riverty Fix – Faste afdrag hver måned';
		$this->extra_information = 'Samme beløb hver måned.';
	...
	public function init_form_fields() {
		...
		$this->form_fields = apply_filters(
			'afterpay_dk_installments_form_fields', array(
				'enabled'                               => array(
					'title'   => __( 'Enable/Disable', 'afterpay-payment-gateway-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => __( 'Enable Riverty Denmark Fixed instalments', 'afterpay-payment-gateway-for-woocommerce' ),
					'default' => 'no',
				),
				'test_api_key'                               => array(
	...
	public function payment_fields() {
		...
		<fieldset class="riverty_fieldset">
			<p class="form-row">
				<label for="afterpay_installmentplan"><strong>Faste afdrag</strong></label>
				<?php 
				...
				<div class="installment_plan 
					...
					<p class="afterpay_terms_and_conditions">
						Samlede omkostninger for <?php echo esc_html( $installment_plan->basketAmount ); ?> kr betalt over <?php echo esc_html( $installment_plan->numberOfInstallments ); ?> måneder er <?php echo esc_html( $installment_plan->totalAmount ); ?> kr med rente <?php echo esc_html( $installment_plan->effectiveAnnualPercentageRate ); ?> %.
